...
let FileName = 'Dylan-Workers-SUB';
...
//节点链接 + 订阅链接
let MainData = `
vless://45ee0712-877c-4a18-a087-7a3cb12c13bf@23.106.131.167:1000?type=tcp&security=reality&sni=authorize.videvo.net&pbk=cDaDzPr3PlS3NM8lreHZbdo-Mhqz8vMBzMSkHXhGIUA&flow=xtls-rprx-vision&fp=chrome#JP-CN2-GIA|Dingyue.love@xray.com
`

let urls = [];
let subconverter = "https://bulianglin-sub.carpediem-dwk.workers.dev"; //在线订阅转换后端，目前使用CM的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_AdblockPlus.ini"; //订阅配置文件
